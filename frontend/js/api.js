const API = {
    ...
    createSecurityByIsin(isin) {
        return this.request('/securities/create-by-isin', { method: 'POST', body: JSON.stringify({ isin }) });
    },
    ...
    refreshAllData(portfolioId) {
        return this.request('/portfolio/refresh-all', {
            method: 'POST',
